          ...
          <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
            ...
            <div>
              <div className='lg:w-[570px]'>
                <h1 className='text-[36px] loading-[46px] text-headingColor font-[800] md:text-[60px]
                md:leading-[70px]'>
                  We help patients live a healthy, longer life
                </h1>
                <p className='text__para'>
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eligendi velit beatae natus modi aspernatur tempore recusandae perferendis neque reiciendis eum eveniet sit illo veniam deleniti et, maiores fugiat enim numquam?
                </p>
        ...
        <div className='container'>
          <div className='flex justify-between gap-[50px] lg:gap-0'>
            ...
            <div className='w-full md:w-1/2'>
              <h2 className='heading'>Most frequent questions by our beloved patients</h2>
